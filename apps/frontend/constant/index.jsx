...
export const FeaturesContent = [
  ...
  },
  {
    title: "LockTime",
    content:
      "One of the greatest parts of the Akila project that plans to do is to set a limit and lock (locktime) an asset in a wallet for a certain amount of time. Suppose you want to transfer an asset (token) or Akila itself to someone. On the other hand, when someone receives it, you want to let him/her to see it in his/her wallet, own it, but cannot transfer it to someone else until a certain date and time. For this purpose, algorithms are implemented that after the transfer of assets, until a certain time, it cannot be transferred to someone else and should wait by the date and time to achieve and then it can be transferred.",
  },
  {
...
export const technicalChar = [
  ...
  "Block reward: 0.5 Akila per block",
  "Total supply: 27,000,000 AKILA",
